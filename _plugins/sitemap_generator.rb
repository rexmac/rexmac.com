...
module Jekyll
  ...
  EXCLUDED_FILES = ["htaccess", "feed", "atom.xml"]
  ...
  class SitemapGenerator < Generator
    ...
    def fill_posts(site, urlset)
      ...
      site.posts.each do |post|
        if !excluded?(post.name) && !post.data['sitemap_exclude']
    ...
    def fill_pages(site, urlset)
      site.pages.each do |page|
        if !excluded?(page.name) && !page.data['sitemap_exclude']
    ...
    def fill_url(site, page_or_post)
      ...
      if (page_or_post.data['layout'] != 'nil' && page_or_post.data['layout'] != nil && site.layouts[page_or_post.data['layout']].data[CHANGE_FREQUENCY_CUSTOM_VARIABLE_NAME])
        change_frequency = site.layouts[page_or_post.data['layout']].data[CHANGE_FREQUENCY_CUSTOM_VARIABLE_NAME].downcase
      end
      ...
      if (page_or_post.data['layout'] != 'nil' && page_or_post.data['layout'] != nil && site.layouts[page_or_post.data['layout']].data[PRIORITY_CUSTOM_VARIABLE_NAME])
        priority_value = site.layouts[page_or_post.data['layout']].data[PRIORITY_CUSTOM_VARIABLE_NAME]
      end
